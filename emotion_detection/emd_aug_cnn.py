...
def run_network(data=None, model=None, epochs=nb_epoch, batch=batch_size):
    try:
        ...
        with open('D:/Erik/Documents/GitHub/MLProjects/model/aug_model.json', 'w') as json_file:
            json_file.write(model_json)
        # serialize weights to HDF5
        model.save_weights('D:/Erik/Documents/GitHub/MLProjects/model/aug_flow.h5')
