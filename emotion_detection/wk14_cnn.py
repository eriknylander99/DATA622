...
def load_data():
    ...
    X_train, X_test, y_train, y_test = train_test_split(X_image, y_image, test_size=0.2, random_state=1234) #, random_state=1234 
...
def init_model():
    ...
    sgd = SGD(lr=0.01, momentum=.8, decay=0.0, nesterov=False)
